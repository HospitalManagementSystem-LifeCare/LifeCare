...
public class AppointmentServiceImpl implements AppointmentService {
	...
	public List<Appointment> getAttendedAppointments() {
		List<Appointment> all = appointmentDao.findByStatus(Appstatus.ATTENDED_AND_PRESCRIP);
		all.addAll(appointmentDao.findByStatus(Appstatus.ATTENDED));
		all.addAll(appointmentDao.findByStatus(Appstatus.ATTENDED_AND_BILL_GENERATED));
