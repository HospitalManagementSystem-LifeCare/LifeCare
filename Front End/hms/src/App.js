...
import ProtectedRoute_patient from "./ProtectedRoute_patient";
import ProtectedRoute_doctor from "./ProtectedRoute_doctor";
...
function App() {
    return <div>
        ...
        <Routes>
            ...
            {/* <Route path="/appointment" element={<ProtectedRoute_patient />}>
                <Route path="" element={<BookAppointment />} />
            </Route> */}
            <Route path="/doctor" element={<ProtectedRoute_doctor />}>
            ...
            <Route path="/patient" element={<ProtectedRoute_patient />}>
              ...
              <Route path="" element={<Admin />}>
                    ...
                    <Route path="/admin/reports" element={<Records />} />
