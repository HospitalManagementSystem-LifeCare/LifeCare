...
function Header() {
  ...
  return (
      <div className='navbar desktop en'>
          <nav className='navbar navbar-expand-lg navbar-light bg-light'  style={{ width: '100%' ,height:'100px' }}>
              <div className='container-fluid'>
                  <a className='navbar-brand' href='/' style={{fontSize : '40px'}}>Sunbeam Hospital</a>
